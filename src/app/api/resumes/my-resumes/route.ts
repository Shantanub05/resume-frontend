...
export async function GET(request: NextRequest) {
  try {
    console.log('API Proxy: Received my-resumes request')
    ...
    const response = await fetch(`${BACKEND_URL}/resumes/my-resumes`, {
      method: 'GET',
      headers: {
    ...
    console.log('API Proxy: Success, returning resumes')
